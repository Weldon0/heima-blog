...
![fail.gif](https://wuxiaohui-1254415986.cos.ap-nanjing.myqcloud.com/uPic/e64e5028369f4e2ea0d93d8007d0d842~tplv-k3u1fbpfcp-watermark.awebp)

调用 submit ，验证失败的情况。

**② 表单验证通过**

![success.gif](https://wuxiaohui-1254415986.cos.ap-nanjing.myqcloud.com/uPic/200b9221b3a7444b85b11a71276f7680~tplv-k3u1fbpfcp-watermark.awebp)

验证成功！

**③ 获取表单的数据层**

![get.gif](https://wuxiaohui-1254415986.cos.ap-nanjing.myqcloud.com/uPic/a708afa9565b427ab545a7890d910e09~tplv-k3u1fbpfcp-watermark.awebp)

通过 getFieldsValue 获取表单数据层。

**④ 重置表单的数据层**

![reset.gif](https://wuxiaohui-1254415986.cos.ap-nanjing.myqcloud.com/uPic/d22e76ea1f0e4cde9ee2eb01013855f3~tplv-k3u1fbpfcp-watermark.awebp)

通过 resetFields 重置表单。

**⑤ 动态添加表单验证规则**

![dongtai.gif](https://wuxiaohui-1254415986.cos.ap-nanjing.myqcloud.com/uPic/14e6d60035764c06b66a9eb877d5b1e8~tplv-k3u1fbpfcp-watermark.awebp)
